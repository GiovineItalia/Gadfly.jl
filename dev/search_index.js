...
{
    "location": "gallery/scales/#[Scale.alpha_continuous](@ref)-1",
    "page": "Scales",
    "title": "Scale.alpha_continuous",
    "category": "section",
...
{
    "location": "lib/scales/#Gadfly.Scale.alpha_continuous-Tuple{}",
    "page": "Scales",
    "title": "Gadfly.Scale.alpha_continuous",
    "category": "method",
    "text": "alpha_continuous[(; minvalue=0.0, maxvalue=1.0, labels=nothing,\n                 format=nothing, minticks=2, maxticks=10, scalable=true)]\n\nRescale the data values between minvalue and maxvalue to opacity (alpha) values between 0 and 1.  \n\n\n\n\n\n"
},

{
    "location": "lib/scales/#Gadfly.Scale.alpha_discrete-Tuple{}",
    "page": "Scales",
    "title": "Gadfly.Scale.alpha_discrete",
    "category": "method",
    "text": "alpha_discrete[(; labels=nothing, levels=nothing, order=nothing)]\n\nSimilar to Scale.x_discrete, except applied to the alpha aesthetic. The alpha palette is set by Theme(alphas=[]).\n\n\n\n\n\n"
},
