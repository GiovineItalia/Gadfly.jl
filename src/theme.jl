...
function default_discrete_highlight_color(fill_color::OpaqueColor)
    return RGB(1, 1, 1)
end

function default_discrete_highlight_color(fill_color::TransparentColor)
    return RGBA{Float32}(
        default_discrete_highlight_color(opaquecolor(fill_color)),
        fill_color.alpha)
end

function default_continuous_highlight_color(fill_color::OpaqueColor)
...
function default_continuous_highlight_color(fill_color::TransparentColor)
    return RGBA{Float32}(
        default_continuous_highlight_color(opaquecolor(fill_color)),
        fill_color.alpha)
end

function default_stroke_color(fill_color::OpaqueColor)
...
function default_stroke_color(fill_color::TransparentColor)
    return RGBA{Float32}(
        default_stroke_color(opaquecolor(fill_color)),
        fill_color.alpha)
end

function default_lowlight_color(fill_color::OpaqueColor)
    fill_color = convert(LCHab, fill_color)
    c = LCHab(fill_color.l, fill_color.c, fill_color.h)
    LCHab(90, 20, c.h)
end
...
function default_lowlight_color(fill_color::TransparentColor)
    return RGBA{Float32}(
        default_lowlight_color(opaquecolor(fill_color)),
        fill_color.alpha)
end

# Choose a middle color by darkening the fill color
function default_middle_color(fill_color::OpaqueColor)
    fill_color = convert(LCHab, fill_color)
...
function default_middle_color(fill_color::TransparentColor)
    return RGBA{Float32}(
        default_middle_color(opaquecolor(fill_color)),
        fill_color.alpha)
end
...
@varset Theme begin
    ...
    # Grid line color.
    grid_color,            ColorOrNothing,  parse(Color, "#D0D0E0")
    grid_strokedash,       Maybe(Vector),   [0.5mm, 0.5mm]

    # Grid lines for focused item.
    grid_color_focused,    ColorOrNothing,  parse(Color, "#A0A0A0")
    ...
    minor_label_color,     ColorOrNothing,  parse(Color, "#6c606b")
    ...
    major_label_color,     ColorOrNothing,  parse(Color, "#564a55")
    ...
    bar_highlight,         Union(Nothing, Function, OpaqueColor),   nothing
